		...
		const char *user, const char *service)
{
	...
	//Kuromesi added
	char password_auth_xpath[sizeof(CONF_USER_XPATH) + CONF_USER_MAXLEN + sizeof("password_auth")];
	snprintf(password_auth_xpath, sizeof(password_auth_xpath), CONF_USER_XPATH, user,
	"password_auth");
	retval = pusb_xpath_get_string(doc,
		password_auth_xpath,
		"true",
